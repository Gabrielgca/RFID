...
CREATE TABLE IF NOT EXISTS `tb_perm_horario` (
  ...
  `dt_ocorrência` DATE NOT NULL COMMENT 'Data ocorrência permissão',
  `hr_incial` TIME NOT NULL COMMENT 'Hora Início permissão',
  `hr_final` TIME NOT NULL COMMENT 'Hora final permissão\n',
...
CREATE TABLE IF NOT EXISTS `tb_perm_usu_disp` (
  ...
  `id_disp_localizacao` INT UNSIGNED NOT NULL COMMENT 'Identificador da localização do dispositivo\n',
...
CREATE TABLE IF NOT EXISTS `tb_rota` (
  ...
  `id_dispositivo_destino` INT UNSIGNED NOT NULL COMMENT 'Identificador do dispositivo(destino)',
  `id_cadastro` INT UNSIGNED NOT NULL COMMENT 'Identificador do cadastro.',
