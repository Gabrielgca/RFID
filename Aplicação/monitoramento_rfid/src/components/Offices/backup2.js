...
class Offices extends Component {
    ...
    constructor(props) {
        ...
        this.state = {
            ...
            offices: [],
            permissions: [],
            selectedOffice: { key: '', nomeCargo: '', status: '' },
            filter: '',
            modalOpen: false,
    ...
    handleDeactivateUserOpen = (office) => {
        this.setState({ selectedOffice: { key: office.key, cargo: office.cargo, nome: office.nome, status: office.status } });
                                        ...
                                        <FlatList
                                            ...
                                            renderItem={(item) => (
                                                <FormControlLabel
                                                    ...
                                                    control={<Checkbox color="primary" checked={item.status} onChange={this.handlePermissionChange} name={item.key} />}
